    ...
    const getAllPublsihedBlogs = async () => {
      try {
        const res = await axios.get(
          `https://mern-stack-application-38nc.onrender.com/api/v1/blog/get-published-blogs`,
  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-800 pb-10">
      ...
      <div className="max-w-7xl mx-auto flex gap-6 ">
        ...
        <div className="bg-white hidden md:block dark:bg-gray-700 w-[350px] p-5 rounded-md mt-10 items-center">
